...
Source0  : https://cran.r-project.org/src/contrib/polspline_1.1.25.tar.gz
...
%setup -q -n polspline
pushd ..
cp -a polspline buildavx2
popd
pushd ..
cp -a polspline buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715629961
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/polspline/libs/polspline.so
/V4/usr/lib64/R/library/polspline/libs/polspline.so
